...
class Idc(models.Model):
    ...
    def __unicode__(self):
        return {"idc_name": self.idc_name,"remark":self.remark, "create_time":self.create_time}
    class Meta:
        verbose_name = u'机房列表'
...
class HostList(models.Model):
    ...
    def __unicode__(self):
        return {"ip": self.ip, "hostname": self.hostname, "group": self.group.id, "application": self.application, "bianhao": self.bianhao, "idc_name": self.idc_name}
    class Meta:
        verbose_name = u'主机列表'
