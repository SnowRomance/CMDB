...
def main():
    ...
    print sapi.remote_execution("iZ94fa46qhcZ", 'user.add', {'arg1': "yangjunliu"})
    print sapi.remote_execution("iZ94fa46qhcZ", 'cmd.run', {'arg1': "usermod -e 2017-01-05 yangjunliu"})
