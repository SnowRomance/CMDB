...
SECRET_KEY = 'e5c6v=fkj37unh&e+crl12ld-0!gjfc+5@18@u#r%tv)y9l#w4'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static')),
]

FILE_ROOT = os.path.join(BASE_DIR, 'static', 'upload')